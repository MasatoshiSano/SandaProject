...
def _send_aggregation_notification(result_instance, action: str) -> None:
    """集計更新のWebSocket通知を送信"""
    try:
        from ..models import send_aggregation_status_notification, send_weekly_analysis_update, Line
